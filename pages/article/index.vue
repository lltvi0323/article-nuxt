  ...
  <div class="article">
    ...
    <div class="article__contents" v-for="(article, index) in articles" :key="article.id">
      ...
      <span>
        ...
        <svg v-if="!isActiveLink(article.id)" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash cursor-pointer ml-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" v-on:click="removeArticle(article.id)">
